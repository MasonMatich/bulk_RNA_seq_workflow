...
cranr <- c("bookdown", "dplyr", "DT", "knitr", "kableExtra", "ashr","htmltools", "ggplot2", "PCAtools", "knitrBootstrap", "stringr", "tibble", "readr", "patchwork", "tidyverse", "RColorBrewer")
...
source("scripts/runDESeq2Analysis.R")
```
