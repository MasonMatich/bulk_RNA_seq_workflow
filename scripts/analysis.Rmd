...
```{r warning=FALSE, results='hide', message=FALSE, echo = (as.logical(trimws(sample_params$batch_correct)))}
if (as.logical(trimws(sample_params$batch_correct))) {
...
### No Regression
```{r warning=FALSE, message=FALSE, results='hide', echo=FALSE, out.width="90%", fig.align="center"}
